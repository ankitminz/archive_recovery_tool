...
while(True):
    ...
    if path.endswith('.zip'):
        ...
        file_type = 2
        unrarExists = os.path.isfile(os.getcwd() + "\\UnRAR.exe")
        break
...
if(file_type != 2 or (file_type == 2 and unrarExists)):
...
if(file_type == 2 and not(unrarExists)):
    print("\nUnRAR.exe doesn't exist in same directory of Craker\nPlease copy and paste UnRAR.exe in given directory\n{}".format(os.getcwd()))
